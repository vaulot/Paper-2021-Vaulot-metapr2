...
colnames <- c("ID", "Name",   "Area",   "Ecosystem", "Substrate", "Samples", "Technology", "Reads", "ASVs", "Bioproject", "DOI")
align <-   c("c", "  p{4cm} ","p{2cm} ", rep("p{2cm}", 2),       rep("c", 4), rep("p{4cm}", 1), rep("p{3.5cm}", 1) )
